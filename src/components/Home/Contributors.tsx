...
const Contributors = () => {
  ...
  const images = [marzbani, naja, president, taminEjtemai, taxirani, airbus, vezaratBehdasht, vezaratErtebatat, asnaf, vezaratKeshvar, vezaratRah, bus, vezaratSanatMadan, xyxy]
  return (
      ...
      <div className="u-center-text u-margin-bottom-big">
        <h3 className="heading-forth">
          ...
          <span className="heading-forth--sub">
            اخذ تصمیمات صحیح در حوزه‌ی مدیریت بحران نیازمند به ایجاد مجموعه سامانه‌هایی است.
            اجرای این پروژه ملی، تنها با همکاری نزدیک دستگاه‌ها و سازمان‌های ذیل میسر شده است.
          </span>
        </h3>
      </div>
