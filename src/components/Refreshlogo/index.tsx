...
const RefreshLogo: React.FC<any> = (props: IProps) => {
  ...
  return (
    <svg
      ...
      style={{transition: `all 1s ease`, backfaceVisibility: 'hidden'}}
    >
      <g>
