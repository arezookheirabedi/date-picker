      ...
      <div className="side-bar-filter__holder relative z-10 h-screen overflow-auto bg-white">
        ...
        <div className="select-radio mb-12">
          <div className="select-radio__group">
            <input type="radio" className="select-radio__input" id="not-done" name="vaccine" />
            <label htmlFor="not-done" className="select-radio__label">
        ...
        <div className="select-radio mb-12">
          <div className="select-radio__group">
            <input type="radio" className="select-radio__input" id="barekat" name="vaccine-type" />
            <label htmlFor="barekat" className="select-radio__label">
              <span className="select-radio__button" />
              برکت
            </label>
          </div>
        ...
        <div className="select-radio mb-12">
          <div className="select-radio__group">
            <input type="radio" className="select-radio__input" id="improved" name="status" />
            <label htmlFor="improved" className="select-radio__label">
              <span className="select-radio__button" />
              بهبود یافتگان
            </label>
          </div>
