...
import inspectionActiveIcon from '../assets/images/icons/inspection-active.svg';
import inspectionIcon from '../assets/images/icons/inspection.svg';
...
const icons = [
  ...
  },
  {
    name: 'inspection',
    icon: inspectionIcon,
    disableIcon: inspectionIcon,
    activeIcon: inspectionActiveIcon,
  },
  {
    name: 'guild',
    icon: guildIcon,
