      ...
      <div
        ...
        <div
          className="flex-grow flex flex-col md:flex-row space-y-5 md:space-y-0 space-x-0  md:space-x-5 rtl:space-x-reverse">
           <Statistic icon={totalCalls} loading={false} text="تعداد کل فراخوانی" count={servicesTotalStatistic.calls || ''}/>
          {/* <Statistic icon={totalCalls} loading={false} text="تعداد کل فراخوانی" count="1102908972"/> */}
           <Statistic icon={totalServices} loading={false} text="تعداد کل خدمات" count={servicesTotalStatistic.endPoints || ''}/>
          {/* <Statistic icon={totalServices} loading={false} text="تعداد کل خدمات" count="70"/> */}
        </div>
        <div
          className="flex-grow flex flex-col md:flex-row space-y-5 md:space-y-0 space-x-0 md:space-x-5 rtl:space-x-reverse">
           <Statistic icon={clientDevices} loading={false} text="دستگاه های سرویس گیرنده" count={servicesTotalStatistic.consumers || ''}/>
