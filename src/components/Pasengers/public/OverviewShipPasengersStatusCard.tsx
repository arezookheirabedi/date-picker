...
const OverviewShipPasengersStatusCard: React.FC<{}> = () => {
  ...
  return (
    <fieldset className="text-center border rounded-xl p-4 mb-16">
      <legend className="text-black mx-auto px-3">نگاه کلی به وضعیت مسافران دریایی در کل کشور</legend>
  ...
  {/* fourth card row */}
        <div
          ...
          <Statistic 
          //  loading={pcrLoading}
           icon={totalVacsinateStart} text="تعداد مراجعات واکسیناسیون بعد از شروع سامانه" 
           count="-"
           />
          <Statistic
...
export default OverviewShipPasengersStatusCard;
