...
const AddOrUpdateUser: React.FC<IAddOrUpdateUser> = ({actionType, actionTitle}) => {
  return (
    <div>
      <h3 className="mb-6">
      ...
      <div>
        <form className="text-base" autoComplete="off">
          ...
          <div className="w-full">
            <div className="button button--primary px-5 justify-start sm:text-xs sm:px-0 sm:justify-center md:text-sm  mx-auto w-52 mb-12">
              {actionType === 'add' && `ثبت ${actionTitle}`}
