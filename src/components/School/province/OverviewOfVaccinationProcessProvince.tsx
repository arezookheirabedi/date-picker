...
const OverviewOfVaccinationProcessProvince: React.FC<OverviewOfVaccinationProvinceProps> = ({
  ...
  const [query, setQuery] = useState<any>({tag: 'edu', retry: false});
  const {
    data: dataset,
    loading,
    error: errorMessage,
  ...
  return (
    <fieldset className="mb-16 rounded-xl border p-4 text-center">
      <legend className="mx-auto px-3 text-black">
        نگاه کلی به روند واکسیناسیون آموزش و پرورش در استان &nbsp;{cityTitle}
      </legend>
...
export default OverviewOfVaccinationProcessProvince;
