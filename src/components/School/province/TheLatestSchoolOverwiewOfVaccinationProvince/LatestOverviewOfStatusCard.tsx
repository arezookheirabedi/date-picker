      ...
      <div className="mt-7 flex flex-col justify-between space-y-8 border-t-4 border-solid border-gray-100 py-5">
        ...
        <div className="flex flex-col justify-between space-y-5 space-x-0 rtl:space-x-reverse md:flex-row md:space-y-0 md:space-x-5">
          <Statistic
            ...
            hasInfo
            infoText="درصد  افرادی که اخرین وضعیت واکسیناسیون انها یک دوز واکسن است. "
            icon={YellowVaccine}
          ...
          <Statistic
            hasInfo
            infoText="درصد  افرادی که اخرین وضعیت واکسیناسیون انها دو دوز واکسن است."
            icon={OrangeVaccine}
          ...
          />
          <Statistic
            infoText="درصد افرادی  که اخرین وضعیت واکسیناسیون انها سه دوز واکسن است."
            hasInfo
            icon={PurppleVaccine}
          ...
          />
          <Statistic
            infoText="درصد  افرادی که اخرین وضعیت واکسیناسیون انها چهاردوز واکسن است."
            icon={DarkgreenVaccine}
        ...
        <div className="flex  flex-col  justify-start space-y-5  space-x-0 rtl:space-x-reverse md:flex-row md:space-y-0 md:space-x-5">
          <Statistic
            infoText="درصد افرادی که اخرین وضعیت واکسیناسیون انها پنج دوز واکسن است."
            icon={BlueVaccine}
