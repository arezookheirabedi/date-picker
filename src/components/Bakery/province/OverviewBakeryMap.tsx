...
interface OverviewBakeryMapProps {
  sideCityStatus?: any;
  cityTitle: any;
...
const OverviewBakeryMap: React.FC<OverviewBakeryMapProps> = ({
  sideCityStatus,
  cityTitle,
  selectDefault,
  destinationId,
  ...
  return (
    <fieldset className="text-center border rounded-xl p-4">
      ...
      نگاه کلی به وضعیت واحدهای خبازی {cityTitle ? ` استان‌ ${cityTitle}` : ''}
      </legend>
...
export default OverviewBakeryMap;
