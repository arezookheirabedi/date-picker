...
interface IOverviewNumberOfInspectedUnits {
  data: any,
  loading: any,
  error: any,
  setQuery: any
...
const OverviewNumberOfInspectedUnits: React.FC<IOverviewNumberOfInspectedUnits> = ({
                                                                                     data,
                                                                                     loading,
                                                                                     error,
                                                                                     setQuery
    ...
    <fieldset className="text-center border rounded-xl p-4 w-1/2">
      ...
      {!loading && !!data.length && (
        <div className="align-center flex w-full flex-col justify-center rounded-lg bg-white p-4 shadow pb-10">
          <Pie data={data} name='تعداد واحد‌های بازرسی شده' sign='واحد'/>
