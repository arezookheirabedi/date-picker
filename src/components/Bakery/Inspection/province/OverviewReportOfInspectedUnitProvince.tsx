...
const OverviewReportOfInspectedUnitProvince: React.FC<OverviewReportOfInspectedUnitProvinceProps> = ({cityTitle}) => {

    const {list: dataset, optionChart : options } = useGetOverviewReportOfInspectedUnit(true);
