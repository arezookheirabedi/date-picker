...
const Vaccination: React.FC<{}> = () => {
  ...
  return (
    <div className="space-y-16 mb-8">
      ...
      <fieldset className="text-center border rounded-xl p-4">
        ...
        <div className="flex flex-col justify-between space-y-8">
          <div className="flex flex-col md:flex-row justify-between space-y-5 md:space-y-0 space-x-0 md:space-x-5 rtl:space-x-reverse">
            ...
            <Statistic
              icon={RedYellowVaccineVirus}
              text="تعداد واکسینه شده دوز اولی مبتلا به کرونا"
              count={1200}
            />
          </div>
          <div className="flex flex-col md:flex-row justify-between space-y-5 md:space-y-0 space-x-0 md:space-x-5 rtl:space-x-reverse">
            <Statistic
              icon={RedGreenVaccineVirus}
              text="تعداد واکسینه شده دوز دومی مبتلا به کرونا"
              count={654}
            />
            <Statistic
              icon={BlackYellowVaccineVirus}
              text="تعداد واکسینه شده دوز اولی فوتی"
              count={428}
            />
            <Statistic
              icon={BlackGreenVaccineVirus}
              text="تعداد واکسینه شده دوز دومی فوتی"
              count={864}
            />
          </div>
      ...
      <fieldset className="text-center border rounded-xl p-4">
        <legend className="text-black mx-auto px-3">وضعیت واکسیناسیون بر مبنای گروه سنی</legend>
        {/* <div>head</div> */}
