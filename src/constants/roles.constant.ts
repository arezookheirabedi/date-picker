export const ROLES = {
  ...
  ROLE_ADMIN_HEALTH_GUILD_OWNER: 10141,
  ROLE_ADMIN_HEALTH_GUILD_OWNER_GENERAL: 101411,
  ROLE_ADMIN_HEALTH_GUILD_OWNER_PROVINCE: 101412,
  ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE: 10142,
  ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE_GENERAL: 101421,
  ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE_PROVINCE: 101422,
...
export const getRoles = {
  ...
  [ROLES.ROLE_ADMIN_HEALTH]: [PERMISSIONS_HEALTH],
  [ROLES.ROLE_ADMIN_HEALTH_SERVICEPORT]: [PERMISSIONS_HEALTH],
  [ROLES.ROLE_ADMIN_HEALTH_VACCINATION]: [],
  [ROLES.ROLE_ADMIN_HEALTH_VACCINATION_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_VACCINATION_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_TRANSPORT]: [],
  [ROLES.ROLE_ADMIN_HEALTH_TRANSPORT_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_TRANSPORT_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_TRANSPORT_AUDIT]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_OWNER]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_OWNER_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_OWNER_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_EMPLOYEE_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_GUILD_AUDIT]: [],
  [ROLES.ROLE_ADMIN_HEALTH_PASSENGER]: [],
  [ROLES.ROLE_ADMIN_HEALTH_PASSENGER_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_PASSENGER_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_SCHOOL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_SCHOOL_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_SCHOOL_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_RECRUITMENT]: [],
  [ROLES.ROLE_ADMIN_HEALTH_RECRUITMENT_GENERAL]: [],
  [ROLES.ROLE_ADMIN_HEALTH_RECRUITMENT_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_HEALTH_REPORTS]: [],
  [ROLES.ROLE_ADMIN_GUILD]: [],
  [ROLES.ROLE_ADMIN_GUILD_BAKERY]: [],
  [ROLES.ROLE_ADMIN_GUILD_BAKERY_GENERAL]: [],
  [ROLES.ROLE_ADMIN_GUILD_BAKERY_PROVINCE]: [],
  [ROLES.ROLE_ADMIN_ZAERIN]: [],
};
